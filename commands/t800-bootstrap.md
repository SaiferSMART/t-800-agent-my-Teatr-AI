...
#### 3a. Язык rules (русский)

Если пользователь просит rules на русском или это явное предпочтение:

```bash
bash scripts/install-russian-rules-rule.sh --yes
```

#### 3b. Маршрутизация T-800 (после согласия)
